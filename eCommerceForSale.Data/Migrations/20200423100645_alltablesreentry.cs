...
{
    public partial class alltablesreentry : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TansactionId = table.Column<string>(nullable: true),
                    PhoneNumber = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderHeaders_Coupon_CouponId",
                        column: x => x.CouponId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceForWeights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PriceForWeights_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PriceForWeights_ProductWeights_WeightId",
                        column: x => x.WeightId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(nullable: false),
                    Count = table.Column<int>(nullable: false),
                    WeightPriceId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_PriceForWeights_WeightPriceId",
                        column: x => x.WeightPriceId,
                        principalTable: "PriceForWeights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceForWeights_ProductId",
                table: "PriceForWeights",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceForWeights_WeightId",
                table: "PriceForWeights",
                column: "WeightId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_WeightPriceId",
                table: "ShoppingCarts",
